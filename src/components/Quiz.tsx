...
function scoreColor(score: number): string {
  if (score === 100) return "text-yellow-500 dark:text-yellow-400";
        ...
        <div className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-8">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 px-6 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors font-medium cursor-pointer border border-slate-300 dark:border-slate-600"
            >
              Generate New Quiz
            </button>
            <button
    ...
    <div className="rounded-lg border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-8">
      ...
      <div className="flex gap-3">
        <button
          ...
          className="px-6 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-lg hover:bg-slate-200 dark:hover:bg-slate-700 disabled:bg-slate-100 dark:disabled:bg-slate-700 disabled:text-slate-300 dark:disabled:text-slate-600 transition-colors font-medium cursor-pointer border border-slate-300 dark:border-slate-600"
        >
          Previous
        </button>
        <button
          onClick={handleNext}
          disabled={!answered}
          className="flex-1 px-6 py-2 bg-emerald-600 text-white rounded-lg hover:bg-emerald-500 disabled:bg-slate-200 dark:disabled:bg-slate-700 disabled:text-slate-400 dark:disabled:text-slate-600 transition-colors font-medium cursor-pointer"
        >
